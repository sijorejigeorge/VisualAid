...
//    }
    ...
    private void promptUserAgain() {
     //   textToSpeech.speak("Please say start command to navigate to the next page after the beep sound", TextToSpeech.QUEUE_FLUSH, null, null);
      //  speechRecognizer.stopListening();
        startListeningWithTimeout();
    }
    ...
    private void speakOut() {
        String text = "Hi, Welcome to the Visual Aid. Let us help you get started. Click on the 'Start' button or say 'Start' to initiate the process after you hear a beep sound.";
        textToSpeech.speak(text, TextToSpeech.QUEUE_FLUSH, null, "uniqueId");
    }
